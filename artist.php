...
<!--        // ARTISTE 1 //    -->
    <div class="white artist-txt col3 mg-l30">
        <h2 class="orange mt-0">Tokyo Luv</h2>
        <p>Artiste du mois</p>
...
<!--        // ARTISTE 2 //    -->
    <div class="white artist-txt col3 mg-l30">
        <h2 class="orange mt-0">Ian Dooley</h2>
        <p>Exposition - Juin 2020</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti sit optio quasi iste aut natus quas temporibus tempore suscipit voluptatibus aperiam modi incidunt perspiciatis, rem sint culpa dolor molestiae, dignissimos!</p>
    </div>
    ...
    <!--        // ARTISTE 3 //    -->
    <div class="white artist-txt col3 mg-l30">
        <h2 class="orange mt-0">Daphne Engelke</h2>
        <p>Exposition - Juillet 2020</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti sit optio quasi iste aut natus quas temporibus tempore suscipit voluptatibus aperiam modi incidunt perspiciatis, rem sint culpa dolor molestiae, dignissimos!</p>
    </div>
    ...
    <!--        // ARTISTE 4 //    -->
    <div class="white artist-txt col3 mg-l30">
        <h2 class="orange mt-0">Alex Holyoake</h2>
        <p>Exposition - Septembre 2020</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti sit optio quasi iste aut natus quas temporibus tempore suscipit voluptatibus aperiam modi incidunt perspiciatis, rem sint culpa dolor molestiae, dignissimos!</p>
    </div>
